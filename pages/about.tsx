  ...
  return (
    <>
      <div className="grid h-[calc(100vh-72px)] md:grid-cols-2">
        ...
        <div className="relative h-[70%] max-h-[500px] hidden md:block justify-end self-end">
          <Image
      ...
      <div className="grid items-center justify-center px-5">
        <div className="grid justify-center h-screen text-center">
          <Heading variant="h1" className="max-w-[60ch] self-center text-2xl md:text-6xl">
            Die Welt liegt im digitalen Umbruch
          </Heading>
        </div>

        <div className="grid justify-center h-screen md:text-center">
          <Heading variant="h3" className="max-w-[60ch] self-center text-base md:text-2xl">
